...
int main(int argc, char **argv) {
    ...
    for (;;) {
        ...
        // (1) Raw Acquisition → raw_f32 (interleaved by channel)
        ...
        // (3) Time Average / Decimation → ta_out[n_ta * 8]
        ...
        if (n_ta > 0) {
            ...
            // (10) RS232/RS485 text stream (yt only, 4ch)
#ifdef _WIN32
